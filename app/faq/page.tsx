...
// working without JS; the open animation lives in globals.css.
      ...
      {sections.map((section, i) => {
        ...
        return (
          <section
            ...
            className={cn(
              "px-4 py-16 md:py-24",
              i % 2 === 1 ? "bg-plaster-muted" : "bg-plaster"
            )}
          >
            <div className="mx-auto max-w-2xl">
              ...
              <Reveal delayMs={100}>
                <div className="mt-6 divide-y divide-sage/50 bg-plaster-bright ring-1 ring-sage/50">
                  {section.items.map((item) => (
                    <details key={item.question} className="group">
                      <summary className="flex cursor-pointer list-none items-center justify-between gap-6 p-5 transition-colors duration-200 ease-out-quart hover:bg-plaster md:px-6 [&::-webkit-details-marker]:hidden">
